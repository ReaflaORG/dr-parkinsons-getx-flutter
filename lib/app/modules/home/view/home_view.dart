                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () => Get.toNamed(Routes.SOCIALWELFARE),
                        child: Row(
                          children: [
                            Text(
                              '더보기',
                  ...
                  Container(
                    ...
                    padding: const EdgeInsets.only(
                        top: 16, left: 20, bottom: 16, right: 21),
                    decoration: BoxDecoration(
                      border: Border.all(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return InkWell(
                          onTap: () => Get.toNamed(Routes.SOCIALWELFAREPOST),
                          child: Container(

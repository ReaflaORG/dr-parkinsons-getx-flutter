  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: const [
        ...
        MedicineItemDescriptionWidget(
          text:
              '''콤트억제제는 콤트라는 말초에서 도파민을 분해하는 효소를 차단해서 레보도파의 혈중농도를 더 높게 유지 할 수 있게 하는 약제로, 레보도파의 이용률을 증가시키고 지속시간을 증가시킨다. 레보도파/도파탈탄산효소(Dopadecarboxylase) 억제제 표준치료제로 개선되지 않는 파킨슨병 환자의 운동 동요증상의 치료제로 쓰이며 약효소진 증상의 호전과 악화된 파킨슨 증상을 감소 시킬 수 있다. 현재 국내에서 처방가능한 콤트억제제는 엔타카폰과 오피카폰 두가지 제제이다. ''',
        ),
        SizedBox(
          height: 20,
        ),
        ...
        MedicineItemLabel1Widget(text: '1. 엔타카폰'),
        MedicineImageItem(
